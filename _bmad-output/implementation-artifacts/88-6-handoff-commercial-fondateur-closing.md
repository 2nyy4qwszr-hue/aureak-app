...
- [x] Task 1 — Filtre closing (AC: #1, #2)
...
- [x] Task 2 — Vue enrichie closing (AC: #3, #4, #5)
...
- [x] Task 3 — Actions rapides (AC: #6, #7, #8)
...
- [x] Task 4 — Notification fondateur (AC: #10)
...
| `supabase/migrations/00152_prospect_closing_notification.sql` | CRÉER (optionnel) | Trigger notification admin quand statut = rdv_qualifie (si table notifications existe) |
