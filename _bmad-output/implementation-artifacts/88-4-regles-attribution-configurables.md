...
- [x] Task 1 — Migration Supabase `00150_create_attribution_rules.sql` (AC: #1, #2, #3, #9)
...
- [x] Task 4 — UI page attribution (AC: #4, #5, #6)
...
- [x] Task 5 — Formulaire règle (AC: #6)
...
- [x] Task 6 — Modale conversion avec attribution (AC: #7, #8)
...
- Numéro de migration : `00150` (après 00149 de story 88-3).

### Fichiers à créer / modifier
| Fichier | Action | Notes |
|---------|--------|-------|
| `supabase/migrations/00150_create_attribution_rules.sql` | CRÉER | Table + index unique + RLS + seed |
...
- `supabase/migrations/00148_create_club_prospects_pipeline.sql` — sauf si ajout colonne `attribution_result` JSONB à `club_prospects` (dans ce cas, migration séparée dans 00150)
- `supabase/migrations/00149_create_prospect_actions.sql` — migration story 88-3
