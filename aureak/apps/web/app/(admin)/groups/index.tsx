...
export default function GroupsPage() {
  ...
  return (
    <ScrollView style={s.container} contentContainerStyle={s.content}>
      ...
      <View style={s.header}>
        <View>
          <AureakText variant="h2">Groupes</AureakText>
          {!loading && (
      ...
      <View style={s.filterRow}>
        ...
        <View style={s.filterGroup}>
          ...
          >
            <AureakText variant="caption" style={{ color: implantFilter === 'all' ? colors.accent.gold : colors.text.secondary, fontWeight: implantFilter === 'all' ? '700' : '400' }}>
              Toutes
            </AureakText>
          </Pressable>
          {implantations.map(i => (
            ...
            >
              <AureakText variant="caption" style={{ color: implantFilter === i.id ? colors.accent.gold : colors.text.secondary, fontWeight: implantFilter === i.id ? '700' : '400' }}>
                {i.name}
              </AureakText>
            </Pressable>
          ))}
        ...
        <View style={s.filterGroup}>
          ...
          >
            <AureakText variant="caption" style={{ color: methodFilter === 'all' ? colors.accent.gold : colors.text.secondary, fontWeight: methodFilter === 'all' ? '700' : '400' }}>
              Toutes méthodes
            </AureakText>
          </Pressable>
          {GROUP_METHODS.map(m => (
            ...
            >
              <AureakText variant="caption" style={{ color: methodFilter === m ? METHOD_COLOR[m] : colors.text.secondary, fontWeight: methodFilter === m ? '700' : '400' }}>
                {m}
              </AureakText>
            </Pressable>
          ))}
      ...
      {loading ? (
        ...
        <View style={s.emptyState}>
          <AureakText variant="h3" style={{ color: colors.text.secondary }}>Aucun groupe</AureakText>
