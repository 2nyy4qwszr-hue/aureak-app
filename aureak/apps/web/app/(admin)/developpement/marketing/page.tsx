...
const KPI_ITEMS: KpiItem[] = [
  { label: 'Campagnes actives',           value: '—' },
  { label: 'Inscriptions depuis campagnes', value: '—' },
  { label: 'Reach total',                 value: '—' },
]
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.sub}>Campagnes, inscriptions et portée de vos actions de communication</Text>
      </View>
