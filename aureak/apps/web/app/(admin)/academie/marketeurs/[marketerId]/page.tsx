          ...
          <View style={s.section}>
            <View style={s.infoCard as never}>
              ...
              <View style={s.infoRow}>
                ...
                <AureakText style={s.infoValue as TextStyle}>Marketeur</AureakText>
              </View>
            </View>
          </View>
        )}
          ...
          <View style={s.section}>
            <View style={s.infoCard as never}>
              <AureakText variant="body" style={s.emptyText}>
                Les données marketing seront disponibles avec l'epic 91.
              </AureakText>
              <View style={{ height: space.md }} />
              <Pressable
                onPress={() => router.push('/marketing' as never)}
                style={({ pressed }) => [s.marketingLink, pressed && { opacity: 0.7 }] as never}
              >
                <AureakText style={s.marketingLinkText as TextStyle}>
                  Voir activité marketing →
                </AureakText>
              </Pressable>
            </View>
          </View>
...
const s = StyleSheet.create({
  ...
  marketingLinkText: { fontSize: 13, fontWeight: '700', color: colors.text.dark },
