...
const styles: Record<string, React.CSSProperties> = {
  ...
  empty      : { color: colors.text.secondary, fontSize: '15px' },
  card       : { backgroundColor: colors.background.surface, borderRadius: '12px', padding: '20px', marginBottom: '12px' },
  ...
  date       : { fontSize: '12px', color: colors.text.secondary, marginLeft: 'auto' },
  meta       : { display: 'flex', gap: '20px', marginBottom: '10px' },
  metaItem   : { fontSize: '13px', color: colors.text.secondary },
  code       : { fontFamily: 'monospace', fontSize: '12px', color: colors.text.secondary },
  fileLink   : { display: 'inline-block', color: colors.accent.gold, fontSize: '13px', marginBottom: '10px' },
  actions    : { display: 'flex', gap: '10px', marginTop: '10px' },
  btnOk      : { padding: '7px 14px', borderRadius: '6px', border: 'none', backgroundColor: colors.status.present, color: colors.background.primary, cursor: 'pointer', fontWeight: 600 },
  btnDanger  : { padding: '7px 14px', borderRadius: '6px', border: 'none', backgroundColor: colors.status.absent, color: colors.text.primary, cursor: 'pointer', fontWeight: 600 },
}
