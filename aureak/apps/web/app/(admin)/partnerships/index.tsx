...
const styles: Record<string, React.CSSProperties> = {
  ...
  createBtn    : { padding: '10px 18px', borderRadius: '8px', border: 'none', backgroundColor: colors.accent.gold, color: colors.text.primary, cursor: 'pointer', fontWeight: 600 },
  error        : { color: colors.status.absent, fontSize: '14px', marginBottom: '10px' },
  empty        : { color: colors.text.secondary, fontSize: '14px' },
  partnerCard  : { backgroundColor: colors.background.surface, borderRadius: '12px', padding: '16px', marginBottom: '10px' },
  ...
  inactiveBadge: { fontSize: '11px', padding: '2px 8px', borderRadius: '4px', backgroundColor: colors.accent.zinc, color: colors.text.secondary, fontWeight: 600 },
  partnerMeta  : { display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '8px' },
  metaChip     : { fontSize: '12px', padding: '2px 8px', borderRadius: '4px', backgroundColor: colors.accent.zinc, color: colors.text.secondary },
  statChip     : { fontSize: '12px', padding: '2px 8px', borderRadius: '4px', backgroundColor: 'rgba(59,130,246,0.15)', color: colors.text.primary },
  partnerNotes : { fontSize: '13px', color: colors.text.secondary, marginBottom: '10px', fontStyle: 'italic' },
  partnerActions: { display: 'flex', gap: '8px' },
  revokeBtn    : { padding: '6px 12px', borderRadius: '6px', border: 'none', backgroundColor: colors.status.absent, color: colors.text.primary, cursor: 'pointer', fontSize: '13px', fontWeight: 600 },
}
