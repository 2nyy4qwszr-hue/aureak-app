...
const s = StyleSheet.create({
  ...
  // Cellules — plus larges + lisibles
  colName     : { flex: 2, minWidth: 160 },
  colDates    : { flex: 1.4, minWidth: 150 },
  colInfo     : { flex: 1.5, minWidth: 130 },
  colCountSm  : { width: 80, textAlign: 'center' as never },
