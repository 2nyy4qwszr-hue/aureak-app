...
const styles: Record<string, React.CSSProperties> = {
  container  : { padding: '24px', backgroundColor: colors.light.primary, minHeight: '100vh', color: colors.text.dark, maxWidth: '720px' },
  loading    : { padding: '24px', textAlign: 'center', color: colors.text.muted },
  title      : { fontSize: '28px', fontWeight: 700, marginBottom: '4px' },
  uid        : { fontSize: '13px', color: colors.text.muted, fontFamily: 'monospace', marginBottom: '24px' },
  ...
  btnWarn    : { padding: '8px 16px', borderRadius: '6px', border: 'none', backgroundColor: colors.accent.gold, color: colors.light.primary, cursor: 'pointer', fontWeight: 600 },
  btnOk      : { padding: '8px 16px', borderRadius: '6px', border: 'none', backgroundColor: colors.status.present, color: colors.light.primary, cursor: 'pointer', fontWeight: 600 },
  btnDanger  : { padding: '8px 16px', borderRadius: '6px', border: 'none', backgroundColor: colors.status.absent, color: '#FFFFFF', cursor: 'pointer', fontWeight: 600 },
  btnSecondary: { padding: '8px 16px', borderRadius: '6px', border: '1px solid #E5E7EB', backgroundColor: 'transparent', color: colors.text.muted, cursor: 'pointer' },
  input      : { width: '100%', padding: '8px 12px', borderRadius: '6px', border: '1px solid #E5E7EB', backgroundColor: colors.light.primary, color: colors.text.dark, fontSize: '14px', marginBottom: '12px', boxSizing: 'border-box' },
  confirmBox : { marginTop: '12px' },
  confirmText: { color: colors.text.muted, marginBottom: '12px', fontSize: '14px' },
  ...
  eventRow   : { display: 'flex', gap: '10px', alignItems: 'center', backgroundColor: colors.light.surface, borderRadius: '6px', padding: '10px 14px', marginBottom: '8px', fontSize: '14px' },
  eventType  : { textTransform: 'capitalize', fontWeight: 600 },
  eventReason: { color: colors.text.muted, flex: 1 },
  eventDate  : { color: colors.text.muted, fontSize: '12px', whiteSpace: 'nowrap' },
}
