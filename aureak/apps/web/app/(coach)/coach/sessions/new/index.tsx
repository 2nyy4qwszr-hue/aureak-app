...
const F: Record<string, React.CSSProperties> = {
  page     : { padding: '32px 40px', maxWidth: 560, backgroundColor: colors.background.primary, minHeight: '100vh', color: colors.text.primary },
  back     : { fontSize: 13, color: colors.text.secondary, background: 'none', border: 'none', cursor: 'pointer', padding: 0, marginBottom: 20, transition: 'color 0.15s' },
  title    : { fontSize: 26, fontWeight: 700, fontFamily: 'Rajdhani, sans-serif', margin: '0 0 28px', color: colors.text.primary },
  form     : { display: 'flex', flexDirection: 'column', gap: 20 },
  field    : { display: 'flex', flexDirection: 'column', gap: 6 },
  label    : { fontSize: 12, fontWeight: 700, color: colors.text.secondary, textTransform: 'uppercase', letterSpacing: '0.06em' },
  req      : { color: colors.accent.gold },
  hint     : { fontSize: 12, color: colors.text.secondary, marginTop: 4 },
  input    : {
    padding        : '10px 12px',
    borderRadius   : 7,
  ...
  btnCancel: { padding: '10px 20px', borderRadius: 7, border: `1px solid ${colors.accent.zinc}`, backgroundColor: 'transparent', color: colors.text.secondary, fontSize: 14, fontWeight: 600, cursor: 'pointer' },
