-- Fix : check_academy_milestones référençait `attendance_records` qui n'existe pas.
-- La table actuelle s'appelle `attendances` (cf. migration 00136).
-- Erreur runtime: 42P01 relation "attendance_records" does not exist.
